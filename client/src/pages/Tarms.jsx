    ...
    <MainSection>
        ...
        <div className="prose prose-lg">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                CTG Event Plus reserves the right to suspend accounts violating
                our policies
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">CTG Event Plus is not responsible for:</p>
            <ul className="list-disc pl-6 space-y-2">
      ...
      {activeTab === "privacy" && (
        <div className="prose prose-lg">
          ...
          <section className="mb-8">
            <p className="mb-4">
              At <strong>CTG Event Plus</strong>, we value your privacy. This
